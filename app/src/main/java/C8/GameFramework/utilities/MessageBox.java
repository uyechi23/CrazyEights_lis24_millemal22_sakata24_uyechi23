package C8.GameFramework.utilities;
...
public class MessageBox {
     ...
     * @param activity the current activity. (Nothing will be shown if the activity is null.)
     */
     ...
     *
     * @param msg           the message to post
     * @param posButtonText the "positive" button text
     * @param negButtonText the "negative" button text
     * @param posListener   the listener, if any, to activate when the positive
     *                      button is pressed
     * @param negListener   the listener, if any, to activate when the negative
     *                      button is pressed
