...
import C8.GameFramework.utilities.IPCoder;
import C8.GameFramework.utilities.Logger;
import C8.GameFramework.utilities.NetworkObjectPasser;
...
public class ProxyGame implements Game {
     ...
     *
     * @param portNum the port number for connecting to the host
     * @param ipCode  the IP code of the server where the game is hosted
     * @return
     */
     ...
     *
     * @param portNum the port number on the server to connect to
     * @param ipCode  the IP code of the remote site to where the actual
     *                game is running
     */
