package C8.GameFramework;

import android.os.Handler;
import android.os.Looper;
import android.os.Message;

import C8.GameFramework.actionMessage.EndTurnAction;
import C8.GameFramework.actionMessage.GameAction;
import C8.GameFramework.actionMessage.GameOverAckAction;
import C8.GameFramework.actionMessage.MyNameIsAction;
import C8.GameFramework.actionMessage.ReadyAction;
import C8.GameFramework.actionMessage.TimerAction;
import C8.GameFramework.infoMessage.BindGameInfo;
...
import C8.GameFramework.infoMessage.StartGameInfo;
import C8.GameFramework.players.GamePlayer;
import C8.GameFramework.utilities.GameTimer;
import C8.GameFramework.utilities.Logger;
import C8.GameFramework.utilities.Tickable;
        ...
        if (msg.obj instanceof GameAction) { // ignore if not GameAction
            ...
            if (action instanceof MyNameIsAction &&
                ...
                if (playerReadyCount >= playerNames.length) {
                    ...
                    //if (this.state.getNumSetupTurns() == 0) { //getNumSetupTurns is null
                        gameStage = GameStage.DURING_GAME;
                    //}
                    Logger.log(TAG, "Num of setup turns is " /* + this.state.getNumSetupTurns()*/); //null
